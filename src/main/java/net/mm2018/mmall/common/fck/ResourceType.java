package net.mm2018.mmall.common.fck;
...
public class ResourceType {
    ...
    static {
        PropertiesLoader propertiesLoader = new PropertiesLoader("classpath:/config/fckeditor.properties");
    ...
    public static final ResourceType FILE =
            new ResourceType("File", getFileResourceTypePath(), Utils.getSet(getFileResourceTypeAllowedExtensions()),
                    Utils.getSet(getFileResourceTypeDeniedExtensions()));
    /** Resource type <code>Flash</code> */
    public static final ResourceType FLASH =
            new ResourceType("Flash", getFlashResourceTypePath(), Utils.getSet(getFlashResourceTypeAllowedExtensions()),
                    Utils.getSet(getFlashResourceTypeDeniedExtensions()));
    /** Resource type <code>Image</code> */
    public static final ResourceType IMAGE =
            new ResourceType("Image", getImageResourceTypePath(), Utils.getSet(getImageResourceTypeAllowedExtensions()),
                    Utils.getSet(getImageResourceTypeDeniedExtensions()));
    /** Resource type <code>Media</code> */
    public static final ResourceType MEDIA =
            new ResourceType("Media", getMediaResourceTypePath(), Utils.getSet(getMediaResourceTypeAllowedExtensions()),
                    Utils.getSet(getMediaResourceTypeDeniedExtensions()));
     ...
     * @throws IllegalArgumentException if both sets contain extensions
     */
     ...
     * @throws IllegalArgumentException if this class has no constant with the specified name
     * @throws NullPointerException     if <code>name</code> is null or empty
     */
     ...
     * constant.
     *
     * @param name the resource type to check
     ...
     * checked.
     *
     * @param extension the extension to check, empty will fail
    ...
    private static String getFileResourceTypePath() {
    ...
    private static String getFlashResourceTypePath() {
    ...
    private static String getImageResourceTypePath() {
    ...
    private static String getMediaResourceTypePath() {
     ...
     * property
     */
    private static String getFileResourceTypeAllowedExtensions() {
     ...
     * property
     */
    private static String getFileResourceTypeDeniedExtensions() {
     ...
     * property
     */
    private static String getFlashResourceTypeAllowedExtensions() {
     ...
     * property
     */
    private static String getFlashResourceTypeDeniedExtensions() {
     ...
     * property
     */
    private static String getImageResourceTypeAllowedExtensions() {
     ...
     * property
     */
    private static String getImageResourceTypeDeniedExtensions() {
     ...
     * property
     */
    private static String getMediaResourceTypeAllowedExtensions() {
     ...
     * property
     */
    private static String getMediaResourceTypeDeniedExtensions() {
    ...
    private static String getUserFilesAbsolutePath() {
     ...
     *
     * @param obj Object to be compared with this resource type.

...
public class UploadResponse {
     ...
     * @throws IllegalArgumentException if amount of arguments is less than 1 and above 4
     * @throws IllegalArgumentException if the first argument is not an error number (int)
     */
     ...
     * message at the end.
     *
     * @param customMassage the custom message of this upload response
     */
    public void setCustomMessage(final String customMassage) {
        if (!Utils.isBlank(customMassage)) {

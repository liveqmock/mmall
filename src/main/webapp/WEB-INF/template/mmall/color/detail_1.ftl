...
<div class="bd"> <!--上下分界限-->
    ...
    <img style="WIDTH: 220px; height: 150px" alt="" src="${base}/mmall/static/mobile/images/1/ClaB1305170410117253458.jpg"/><br/>
    体积小巧,随插即用的外观设计,iPhone连接T02投影,荧幕可以放大到64寸,视野更宽更大,打造专属个人影院.<br/>
    <img style="WIDTH: 220px; height: 150px" alt="" src="${base}/mmall/static/mobile/images/1/ClaB1305170409293150607.jpg"/><br/><br/>
    我要购买:<br/>
    在线订购:<a href="${base}/mmall/c/order/${id!}">黑色</a><br/>
    <a href="${base}/mmall/c/order/${id!}">立即在线订购>></a><br/>
    商品货到付款,7天包退换!!<br/>

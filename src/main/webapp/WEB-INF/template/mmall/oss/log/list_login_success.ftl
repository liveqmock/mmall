...
<#include "../head.ftl"/>
  <script type="text/javascript">
    ...
    function optDelete() {
      ...
      var f = getTableForm();
      f.action = "o_remove_login_success.jhtml";
      f.submit();
    }
  </script>
</head>
...
<div class="box-positon">
  <div class="rpos">当前位置: 登录成功日志 - 列表</div>
  <form class="ropt" action="o_remove_login_success_batch.jhtml" method="post">
    <span>批量删除</span>
      <select name="days">
...
<div class="body-box">
  <form action="v_list_login_success.jhtml" method="post" style="padding-top:5px;">
  ...
  <@t.table listAction="v_list_login_success.jhtml" value=pagination;ossLog,i,has_next><#rt/>
  ...
  <@t.column title="操作选项" align="center">
    <a href="o_remove_login_success.jhtml?ids=${ossLog.logId}&pageNo=${pageNo!}&queryUsername=${queryUsername!}&queryTitle=${queryTitle!}" onclick="if(!confirm('您确定删除吗？')) {return false;}"
       class="pn-opt">删除</a><#t/>
  </@t.column><#t/>
  </@t.table>

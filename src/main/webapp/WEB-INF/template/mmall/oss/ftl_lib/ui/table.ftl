...
表格标签:用于显示列表数据.
	...
	width:表格的宽度.默认100%.
-->
<#macro table value listAction="v_list.jhtml" class="pn-ltable" style="" theadClass="pn-lthead" tbodyClass="pn-ltbody" width="100%">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td align="center" class="pn-sp">
	...
	<input class="pre-page" type="button" value="上一页" onclick="_gotoPage('${value.prevPage}');"<#if value.firstPage> disabled="disabled"</#if>/>
	...
	当前 ${value.page}/${value.totalPage} 页 &nbsp;转到第<input type="text" id="_goPs" style="width:50px" onfocus="this.select();" onkeypress="if(event.keyCode==13){$('#_goPage').click();return false;}"/>页

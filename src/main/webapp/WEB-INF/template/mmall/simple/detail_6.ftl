<@s.tl title="手机健康仪 - mm2018.net">
手机健康仪<br/>人气值<strong>156</strong>;共<strong>18</strong>条评论<br/>
商城特价:999元(包邮) <a href="${base}/mmall/s/order/${id!}">抢购!</a><br/>
<img src="${base}/mmall/static/mobile/images/6/6-1.jpg" alt="手机健康仪"/><br/>
市场价:3880元<br/>
商城特价:999元(包邮) <a href="${base}/mmall/s/order/${id!}">抢购!</a><br/>
<img src="${base}/mmall/static/mobile/images/7.png"/>7天退换 <img src="${base}/mmall/static/mobile/images/hdfk.png"/>货到付款
<img src="${base}/mmall/static/mobile/images/zheng.png"/>正品保证<br/>
我要购买:<br/>
在线订购:<a href="${base}/mmall/s/order/${id!}">手机健康仪</a><br/>

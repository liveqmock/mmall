 ...
 *            boolean of checked
 */
Kxa.checkbox = function(name, checked) {
 ...
 */
Kxa.checkedCount = function(name) {
 ...
 * 颜色选择器
 */
Kxa.ColorPicker = function(input) {
  var obj = this;
  this.isShow = false;
  this.target = $(input);
  ...
  this.createPicker = function() {
    ...
    for (var i = 0, len = c.length; i < len; i++) {
      s += "<td width='15'><div class='c' style='width:13px;height:13px;"
              + "border:1px solid #fff;cursor:pointer;background-color:" + c[i] + "' title='" + c[i]
              + "'>&nbsp;<div></td>";
